...
## Files
- `UnstructuredProject.qmd` – Main Quarto document with code, analysis, and discussion.
- `labeling_sentences.csv` – File with the sentence datasets pre-labeling
- `labeling_sentences1.csv` - File with the sentence datasets post-labeling
